...
main = do
         ...
         let idCollisioni = tutteCoppieCollisioni quadrati []
         putStrLn ("Ci sono "++show (contaQuadrati quadrati)++" quadrati e "++show numeroCollisioni++" collisioni")
         putStrLn ("Gli identificatori delle coppie di quadrati che sono in collisione sono: "++show idCollisioni++" per un totale di "++show (length idCollisioni)++" coppie")
...
tutteCoppieCollisioni :: [Quadrato] -> [(Int,Int)] -> [(Int, Int)]
tutteCoppieCollisioni [] coppie = coppie
tutteCoppieCollisioni (x:xs) coppie = tutteCoppieCollisioni xs (coppie++(coppieCollisioni x xs []))


coppieCollisioni :: Quadrato -> [Quadrato] -> [(Int,Int)] -> [(Int,Int)]
coppieCollisioni quadrato [] coppie = coppie
coppieCollisioni quadrato (q:qs) coppie = if ( (abs ((x quadrato)-(x q))) < (lato quadrato) && ((abs ((y quadrato) - (y q))) < (lato quadrato)) )
                                          then coppieCollisioni quadrato qs ((identificatore quadrato, identificatore q):coppie)
                                          else coppieCollisioni quadrato qs coppie
